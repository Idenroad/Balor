...
[Version française](#addons-system---framework-balor)
...
📖 **Full documentation**: [docs/PHISHING.md](PHISHING.md)
...
📖 **Documentation complète** : [docs/PHISHING.md](PHISHING.md)
...
- **French README**: [../README_fr.md](../README_fr.md)
- **Phishing Addon**: [PHISHING.md](PHISHING.md)
- **balorsh Wrapper**: See main README for usage examples
